...
def view_data(df):
    """asks the user if they would like to view the table and be able to scroll through"""


    while True:
        view_data = input("Would you like to view 5 rows of individual trip data? Enter yes or no?").lower()
        if view_data.lower() not in ('yes','no'):
            print('its a yes or no question. -_-')
            continue
            ...
            print('thank you for viewing the program so far')
            break
    ...
    while view_data.lower() == "yes":
        ...
        if view_display.lower() not in ('yes', 'no'):
            print('How hard to answer yes or no question,i just dont understand what youre saying')
            continue
